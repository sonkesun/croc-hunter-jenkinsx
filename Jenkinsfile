pipeline {
    ...
    stages {
      stage('CI Build and push snapshot') {
        ...
        steps {
          dir ('/home/jenkins/go/src/github.com/cryptopunk3788/croc-hunter-jenkinsx') {
            checkout scm
            container('go') {
          ...
          dir ('/home/jenkins/go/src/github.com/cryptopunk3788/croc-hunter-jenkinsx/charts/preview') {
            container('go') {
              sh "make preview"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/cryptopunk3788/croc-hunter-jenkinsx/charts/croc-hunter-jenkinsx') {
